...
const proposal_open_contract_mock_data = {
    barrier            : '77.005',
    date_settlement    : 1467601890,
    contract_id        : '9324792108',
    underlying         : 'frxAUDJPY',
    currency           : 'USD',
    validation_error   : 'Resale of this contract is not offered.',
    entry_tick         : '77.005',
    current_spot       : '77.011',
    date_start         : 1467601830,
    id                 : 'E1B3A778-4194-11E6-BAA6-94FA35FED3E5',
    purchase_time      : 1467601830,
    transaction_ids    : { buy: '18562880908' },
    barrier_count      : 1,
    contract_type      : 'CALL',
    is_intraday        : 1,
    is_settleable      : 0,
    is_valid_to_sell   : 0,
    shortcode          : 'CALL_FRXAUDJPY_10_1467601830_1467601890_S0P_0',
    bid_price          : '5.16',
    ...
    is_path_dependent  : 0,
    date_expiry        : 1467601890,
    entry_tick_time    : 1467601831,
    entry_spot         : '77.005',
    buy_price          : '5.06',
    current_spot_time  : '1467601837',
    payout             : '10',
};
const values_mock_data = {
    9324828148: { indicative: '4.33', buy_price: '5.37' },
    9299986648: { indicative: '5.16', buy_price: '5.14' },
};
...
describe('Portfolio', () => {
    ...
    it('Should have all functions that are being tested', () => {
        expect(portfolio).to.have.any.keys(
            'getBalance',
            'getPortfolioData',
