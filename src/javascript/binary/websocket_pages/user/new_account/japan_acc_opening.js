...
import { detectHedging } from '../../../common_functions/common_functions';
            ...
            FormManager.init(
                ...
                [
                    ...
                    { selector: '#address_state', validations: ['req'] },
                    {
                        ...
                        validations: [
                            ...
                            [
                                ...
                                {
                                    regex  : /^\d{3}-\d{4}$/,
                                    message: 'Please follow the pattern 3 numbers, a dash, followed by 4 numbers.',
                                },
                            ],
                        ],
                    },
                    {
                        ...
                        validations: [
                            ...
                            [
                                ...
                                {
                                    regex  : /^\+?[0-9\s-]+$/,
                                    message: 'Only numbers, space, and hyphen are allowed.',
                                },
                            ],
                            ['min', { min: 6, max: 35 }],
                        ],
                    },
                    {
                        ...
                        validations: ['req', ['min', { min: 1, max: 50 }]],
                    },
                    {
                        selector   : '#daily_loss_limit',
                    ...
                    {
                        request_field: 'residence',
                        value        : Client.get('residence'),
                    },
