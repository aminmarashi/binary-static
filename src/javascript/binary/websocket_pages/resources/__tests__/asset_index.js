...
describe('Asset Index', () => {
    ...
    it('Should getAssetIndexData() have all expected data', () => {
        ...
        asset_index_data.forEach((asset_index_item) => {
            ...
            expect(asset_index_item[3]).to.be.an('object').and.to.have.property('market').that.is.a('string');
            expect(asset_index_item[3]).and.to.have.property('submarket').that.is.a('string');
            expect(asset_index_item[3]).to.have.property('submarket').that.is.a('string');
    ...
    it('Should getMarketColumns() have all expected data', () => {
        ...
        Object.keys(market_columns).forEach((market) => {
            expect(market_columns[market]).to.have.property('columns').that.is.an('array');
